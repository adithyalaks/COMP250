 ...
 */ 		
    ...
    //	list = readWordsFromFile(fileName);
 	 ...
 	 String fileName = "/Users/adithya/Desktop/McGill /Fall 2017/COMP 250/Assignment3/src/bodybuilding.txt";
 	 list = readWordsFromFile(fileName);
    ...
    //For debugging, we suggest you use a smaller set of words such as the ones shown in the PDF.      
		...
		System.out.println("WordTree contains 'football' = " + wordTree.contains("football") + " (true) ");
		System.out.println("WordTree contains" + wordTree.getListPrefixMatches("").size());
/*
		...
		System.out.println("c = " + wordTree.getListPrefixMatches("cabo"));*/
